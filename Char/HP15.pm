...
10% everything else. But this "text" means US-ASCII text, and popular HP-15
...
Perl3 or later can treat HP-15.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::HP15 software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw HP-15, Doesn't use UTF8 flag like JPerl
...
It has already been achieved by HP-15 designed for combining with
...
Contrasting is Encode module and describing "use Char::HP15;" on this software,
