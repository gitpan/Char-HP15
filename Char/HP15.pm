...
sub Char::HP15::escape_script {
    ...
    if (/^ use Char::Ehp15(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        # use Char::HP15 version qw(ord reverse);
        $function_ord     = 'ord';
        $function_ord_    = 'ord';
...
=head1 SYNOPSIS
  ...
  use Char::HP15 qw(ord reverse); --- demand enhanced feature of ord and reverse
  use Char::HP15 ver.sion qw(ord reverse);
  use Char::HP15 ver.sion.0 qw(ord reverse);
