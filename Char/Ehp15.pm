...
This module is a run-time routines of the Char::HP15 module.
Because the Char::HP15 module automatically uses this module, you need not use directly.
