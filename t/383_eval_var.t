...
# eval $var has eval "..."
$var = <<'END';
eval Char::HP15::escape " if ('アソ' !~ /A/) { return 1 } else { return 0 } "
END
if (eval Char::HP15::escape $var) {
...
$var = <<'END';
eval Char::HP15::escape qq{ if ('アソ' !~ /A/) { return 1 } else { return 0 } }
END
if (eval Char::HP15::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval Char::HP15::escape ' if (qq{アソ} !~ /A/) { return 1 } else { return 0 } '
END
if (eval Char::HP15::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Char::HP15::escape q{ if ('アソ' !~ /A/) { return 1 } else { return 0 } }
END
if (eval Char::HP15::escape $var) {
