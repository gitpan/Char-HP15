...
http://search.cpan.org/dist/Char-HP15/HP15/JA.pm
...
=head1 Multiple-Octet Anchoring Of Regular Expression (HP15.pm provides)
...
=head1 Escaping Second Octet (HP15.pm provides)
...
=head1 Multiple-Octet Character Regular Expression (HP15.pm provides)

HP15.pm clusters multiple-octet character with quantifier, makes cluster from
...
=head1 Calling 'Ehp15::ignorecase()' (HP15.pm provides)
...
Regular expression works as character-oriented that has no /b modifier.
  ...
  m?regexp?               m?ditto@Ehp15::matched?
  s/regexp/replacement/   ($_ =~ m/ditto@Ehp15::matched/) ?
                          eval{ Ehp15::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
...
Regular expression works as byte-oriented that has /b modifier.
  ...
  m?regexp?b              m?regexp@Ehp15::matched?
  s/regexp/replacement/b  ($_ =~ m/(\G[\x00-\xFF]*?)(?:regexp)@Ehp15::matched/) ?
                          eval{ Ehp15::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
