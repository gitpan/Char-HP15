...
=head1 Un-Escaping \ of \N, \p, \P, and \X (HP15 software provides)

HP15 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (HP15 software provide)
...
=head1 Escaping File Test Operators (HP15 software provide)
